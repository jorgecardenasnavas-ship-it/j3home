...
export const pt = {
  ...
  academy: {
    hero: {
      ...
      eyebrow: "J3 Academy",
      heading: "Quem recomendamos na tua cidade?",
      sub: "Treinadores formados no nosso m\u00E9todo que recomendamos pessoalmente. Encontra o teu.",
      ctaPrimary: "Encontrar coach perto",
      ctaSecondary: "Conhecer o Lab \u00B7 M\u00E1laga",
