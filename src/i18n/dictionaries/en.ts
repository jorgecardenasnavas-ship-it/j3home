...
export const en = {
  ...
  academy: {
    hero: {
      ...
      eyebrow: "J3 Academy",
      heading: "Who do we recommend in your city?",
      sub: "Coaches trained in our method that we personally recommend. Find yours.",
      ctaPrimary: "Find a coach nearby",
      ctaSecondary: "Visit the Lab \u00B7 M\u00E1laga",
      filtersTitle: "Filter",
    ...
    programs: {
      ...
      headingSub: "Same structure in every club \u2014 three paths built around each age, level and goal.",
