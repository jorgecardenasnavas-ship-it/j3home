...
export const sv = {
  ...
  academy: {
    ...
    network: {
      ...
      legendCoach: "Coach360 certifierad",
      legendCoachVerified: "Coach360 verifierad",
      legendCoachInProgress: "Coach360",
      inProgressBadge: "Under certifieringsprocess",
      inProgressNote: "Tillg\u00E4nglig n\u00E4r J3-certifierad.",
      baseCoachesLine: "+{count} tr\u00E4nare i J3-n\u00E4tverket",
      stageFormacion: "Utbildning",
      stageCertificado: "Certifierad",
      stageVerificado: "Verifierad",
      legendCluster: "Grupp",
