...
function FounderCard({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative flex flex-col gap-6 p-7 sm:p-9 h-full">
        {/* Header — número + rol */}
        <div
        ...
        >
          ...
          <span className="text-[10px] font-bold tracking-[3px] uppercase text-[var(--g1)] whitespace-nowrap">
            {role}
          </span>
        </div>
        ...
        >
          {first}
          <br />
          <span className="text-[var(--g1)]/85">{last}</span>
        </h3>

        {/* Quote italic */}
        <blockquote
          className="relative pl-5 border-l-2 border-[var(--g1)]/45"
          style={{
            opacity: visible ? 1 : 0,
        ...
        >
          <p
            className="italic text-[#E8DDD0]/90 leading-[1.4]"
            style={{
              fontFamily: "var(--font-serif)",
        ...
        <ul className="flex flex-col gap-2.5 pt-4 border-t border-[var(--g1)]/15">
          {highlights.map((h, i) => (
            <li
              key={i}
              className="flex items-baseline gap-3 text-[12.5px] sm:text-[13px] text-[var(--wh)]/78 leading-[1.5] font-light"
              style={{
                opacity: visible ? 1 : 0,
                transform: visible ? "none" : "translateY(8px)",
      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto px-6 sm:px-12 lg:px-20">
        ...
        >
          <FounderCard
            ...
            highlights={[
              "Organizó el WPT Málaga con casi 300 parejas inscritas.",
