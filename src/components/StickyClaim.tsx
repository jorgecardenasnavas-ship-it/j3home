...
export function StickyClaim() {
  ...
  return (
    <div
      className={`fixed top-[64px] left-0 right-0 z-[80] h-[32px] bg-black/55 backdrop-blur-md border-b border-white/[0.04] flex items-center justify-center pointer-events-none transition-opacity duration-500 ${
