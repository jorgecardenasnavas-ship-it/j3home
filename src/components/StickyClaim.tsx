...
export function StickyClaim() {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(248,245,239,0.95)", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", borderBottom: "1px solid rgba(27,61,47,0.10)" }}
    >
      <span className="text-[10px] tracking-[5px] uppercase font-normal select-none">
        ...
        <span className="mx-3" style={{ color: "rgba(27,61,47,0.25)" }}>·</span>
        <span className="font-bold" style={{ color: "rgba(27,61,47,0.55)" }}>{t.hero.coach}</span>
        <span className="mx-3" style={{ color: "rgba(27,61,47,0.25)" }}>·</span>
        <span className="font-bold" style={{ color: "rgba(27,61,47,0.55)" }}>{t.hero.manage}</span>
      </span>
    </div>
  );
}
