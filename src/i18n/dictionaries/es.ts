...
export const es = {
  ...
  academy: {
    ...
    headquarters: {
      ...
      headingPre: "Dos sedes. Una sola ",
      headingAccent: "exigencia.",
      sedeCta: "Ver sede \u2192",
      sedes: [
        {
          ...
          features: ["7 pistas indoor", "Cristal panorámico", "Iluminación LED", "Vestuarios completos", "Parking gratuito", "Cafetería"],
        },
        {
          tag: "P\u00E1del \u00B7 Puerto de la Torre",
          name: "Vals Sport Limoneros",
          detail: "11 pistas \u00B7 Pr\u00F3xima apertura",
          features: ["11 pistas", "Indoor + Outdoor", "Superficie WPT", "Zona fitness", "Fisioterapia", "Pro Shop"],
