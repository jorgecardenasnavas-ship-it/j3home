...
export const en = {
  ...
  academy: {
    ...
    network: {
      ...
      legendCoach: "Coach360 certified",
      legendCoachVerified: "Coach360 verified",
      legendCoachInProgress: "Coach360",
      inProgressBadge: "Certification in progress",
      inProgressNote: "Available once J3 certified.",
      baseCoachesLine: "+{count} coaches in the J3 network",
      stageFormacion: "In training",
      stageCertificado: "Certified",
      stageVerificado: "Verified",
