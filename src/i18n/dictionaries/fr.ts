...
export const fr = {
  ...
  story: {
    ...
    impact: {
      ...
      cantera: [
        "Nous avons form\u00E9 et accompagn\u00E9 des dizaines de jeunes.",
        "Certains sont devenus champions d\u2019Espagne ou du monde.",
        "D\u2019autres ont atteint le circuit professionnel.",
        "Et beaucoup ont int\u00E9gr\u00E9 l\u2019universit\u00E9 de leur choix",
        "en \u00E9tant reconnus sportifs de haut niveau par le CSD.",
      ],
