...
export const es = {
  ...
  story: {
    ...
    impact: {
      ...
      cantera: [
        "Formamos y acompa\u00F1amos a decenas de menores.",
        "Algunos consiguieron ser campeones de Espa\u00F1a o del mundo.",
        "Otros llegaron a competir en el circuito profesional.",
        "Y muchos accedieron a la universidad que eligieron",
        "por ser considerados deportistas de alto rendimiento por el CSD.",
      ],
