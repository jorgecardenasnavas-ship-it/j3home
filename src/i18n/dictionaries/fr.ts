...
export const fr = {
  ...
  academy: {
    hero: {
      ...
      eyebrow: "J3 Academy",
      heading: "Qui recommandons-nous dans ta ville\u00A0?",
      sub: "Des entra\u00EEneurs form\u00E9s \u00E0 notre m\u00E9thode, que nous recommandons personnellement. Trouve le tien.",
      ctaPrimary: "Trouver un coach proche",
      ctaSecondary: "D\u00E9couvrir le Lab \u00B7 M\u00E1laga",
