...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Chevrons anclados al borde inferior */}
      <div aria-hidden className="absolute bottom-6 left-1/2 -translate-x-1/2 z-[5] flex flex-col items-center gap-[2px] pointer-events-none">
        {[0, 1, 2].map((i) => (
          <svg
            key={i}
            width="20"
