...
export const en = {
  ...
  home: {
    ...
    coachFinder: {
      ...
      subtitle: "Certified and verified coaches near you.",
    ...
    timeline: {
      ...
      entries: [
        ...
        },
        {
          ...
          carousel: true,
          slides: [
            { caption: "Locker room \u00B7 Platinum trophy in hand", image: "/images/story/timeline/fip-platinum-cdmx-2024-trophy.jpeg" },
            { caption: "Courtside \u00B7 the final hug", image: "/images/story/timeline/fip-platinum-cdmx-2024.jpeg" },
          ],
        },
        {
          year: "November 2024 \u2013 February 2025",
          title: "The leap to the tour",
          desc: "Four scenes of the same leap. Jos\u00E9 Jim\u00E9nez reaches his first quarterfinals at a Major (Mexico Major Acapulco), closes the year inside the world Top 30 at Milan P2, and opens the following season at Premier Padel Rotterdam P1. Always with J3 at courtside.",
          badge: "World Top 30 \u00B7 Premier Padel \u00B7 2024\u20132025",
          highlight: true,
          carousel: true,
          slides: [
            { caption: "November 2024 \u00B7 Mexico Major Acapulco \u2014 first Major quarterfinals", image: "/images/story/timeline/major-acapulco-2025.jpeg" },
            { caption: "December 2024 \u00B7 Milan P2 \u2014 the team", image: "/images/story/timeline/milan-p2-2024-team.jpeg" },
            { caption: "December 2024 \u00B7 Milan P2 \u2014 World Top 30", image: "/images/story/timeline/milan-p2-2024.jpeg" },
            { caption: "February 2025 \u00B7 Premier Padel Rotterdam P1", image: "/images/story/timeline/rotterdam-p1-2025.jpeg" },
          ],
        },
        {
          year: "Mid 2025",
  ...
  academy: {
    hero: {
      ...
      headingPost: "",
      sub: "We certify those who know the method. We verify those we know apply it with criteria.",
    ...
    network: {
      ...
      badgeGenOne: "Gen ONE",
      badgeVerified: "J3 Certified",
      badgeHq: "Headquarter",
      distinctionFormaCoaches: "Trains other coaches",
      distinctionJugadoresCircuito: "Players in circuit",
      distinctionMultilingue: "Multilingual",
      distinctionDecano: "J3 Veteran",
      distinctionKidsIniciacion: "Kids \u00B7 Intro",
      distinctionJuniorsTecnificacion: "Juniors \u00B7 Development",
      distinctionProtocoloFamiliar: "Family protocol",
      distinctionIniciacionAdulto: "Adult intro",
      distinctionReeducacionTecnica: "Technique reset",
      distinctionGruposMixtos: "Mixed-level groups",
      distinctionBautismoPadel: "First-timer sessions",
      distinctionExperienciaFamiliar: "Family sessions",
      ...
      legendCoach: "Coach360 qualified",
      legendCoachVerified: "Coach360 certified",
      legendCoachInProgress: "Coach360",
      inProgressBadge: "Certification in progress",
      inProgressNote: "Available once J3 certified.",
      baseCoachesLine: "+{count} coaches trained with the Coach360 method",
      stageCoach: "Coach",
      stageCoach360: "Coach360",
      stageCualificado: "Qualified",
      stageVerificado: "Certified",
      legendCluster: "Cluster",
      legendDistinctionsTitle: "Distinctions",
      legendDistGroupProfesional: "Professional track",
      legendDistGroupKids: "Kids & juniors",
      legendDistGroupAmateur: "Adult amateur",
      legendDistGroupVacacional: "Holiday \u00B7 group",
      viewInMaps: "View in Maps",
      viewProfile: "Ver perfil",
      viewAllCta: "Ver los {count} coaches",
      viewFilteredCta: "Ver los {count} resultados completos",
      coachCta: {
        eyebrow: "Are you a coach?",
        title: "Build your path with Coach360.",
        description: "From method to qualification. From qualification to J3 Certified. Next month\u2019s N\u00BA 01 could be yours.",
        cta: "Start with Coach360",
    ...
    clubesHandoff: {
      questions: [
        "Run a club or academy?",
        "Or thinking of starting one?",
      ],
      body: "Plug & play. In 3 months, at another level.",
      cta: "Discover",
    },
  },
