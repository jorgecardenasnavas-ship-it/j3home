      ...
      sedes: [
        {
          ...
          features: ["7 indoor courts", "Panoramic glass", "LED lighting", "Full changing rooms", "Free parking", "Cafeteria"],
        },
        {
          tag: "P\u00E1del \u00B7 Puerto de la Torre",
          name: "Vals Sport Limoneros",
          detail: "11 courts \u00B7 Opening soon",
          features: ["11 courts", "Indoor + Outdoor", "WPT surface", "Fitness zone", "Physiotherapy", "Pro Shop"],
          badge: "Opening soon",
        },
      ],
    },
