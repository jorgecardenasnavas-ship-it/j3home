...
export const en = {
  ...
  story: {
    ...
    impact: {
      ...
      cantera: [
        "We trained and mentored dozens of young players.",
        "Some became champions of Spain or the world.",
        "Others went on to compete on the professional circuit.",
        "And many gained admission to their university of choice",
        "by being recognized as elite athletes by the CSD.",
      ],
