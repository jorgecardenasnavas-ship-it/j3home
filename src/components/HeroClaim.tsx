...
export function HeroClaim({ activeAudience }: HeroClaimProps) {
  ...
  return (
    <div className="pointer-events-none">
      <span
        className={`hero-claim-word block font-bold text-j3-hero uppercase tracking-[-3px] leading-[.88] j3-grad-text ${
      ...
      <span
        className={`hero-claim-word block font-bold text-j3-hero uppercase tracking-[-3px] leading-[.88] text-[var(--wh)] ${
