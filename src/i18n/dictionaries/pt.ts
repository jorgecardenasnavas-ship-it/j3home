...
export const pt = {
  ...
  academy: {
    ...
    network: {
      eyebrow: "Partilhar multiplica",
      headingPre: "Um m\u00E9todo, ",
      headingAccent: "muitas pistas.",
      headingSub: "Coaches que validamos pessoalmente. Mesmo crit\u00E9rio em cada cidade.",
      ...
      badgeGenOne: "Gen ONE",
      badgeRecommended: "Recomendado J3",
      badgeHq: "Headquarter",
      ...
      legendCoach: "Coach certificado",
      legendCoachRecommended: "Coach recomendado J3",
