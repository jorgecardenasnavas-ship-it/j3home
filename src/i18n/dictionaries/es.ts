      ...
      sedes: [
        {
          ...
          features: ["Indoor", "Iluminación LED", "Cristal panorámico", "Cafetería", "Vestuarios", "Gimnasio", "Pro Shop"],
        },
        {
          tag: "P\u00E1del \u00B7 Puerto de la Torre",
          name: "Vals Sport Limoneros",
          detail: "11 pistas \u00B7 Pr\u00F3xima apertura",
          features: ["Outdoor", "Fisioterapia", "Zona fitness", "Pro Shop", "Vestuarios"],
